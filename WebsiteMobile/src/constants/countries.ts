/**
 * Same hardcoded country list as Website/wwwroot/js/App.js's `window.countries` (used there for
 * life event location pickers) — kept identical so both frontends offer the same set.
 */
export const COUNTRIES = [
  ...
  'Congo, Democratic Republic of the Congo', 'Cook Islands', 'Costa Rica', "Cote D'Ivoire", 'Croatia', 'Cuba',
