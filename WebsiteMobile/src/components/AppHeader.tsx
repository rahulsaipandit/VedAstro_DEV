...
export function AppHeader() {
  ...
  return (
    <ThemedView
      style={[styles.bar, { borderColor: theme.backgroundSelected, paddingTop: insets.top }]}
      type="background">
      <Pressable
      ...
      <Modal visible={menuOpen} transparent animationType="fade" onRequestClose={() => setMenuOpen(false)}>
        <Pressable style={styles.backdrop} onPress={() => setMenuOpen(false)}>
          <Pressable
            ...
            <ScrollView contentContainerStyle={[styles.drawerContent, { paddingTop: insets.top + Spacing.four }]}>
